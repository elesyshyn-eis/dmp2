package com.ebsco.eis.medical.services.sse;
...
import com.ebsco.eis.medical.services.sse.pojo.Concept;
import com.ebsco.eis.medical.services.sse.pojo.Mapping;
...
public class SemanticService {
	...
	public Recommendations getRecommendations(String query) {
		
		Recommendations recommendations = new Recommendations();
		String permutation = getBestPermutation(query);
		recommendations.setBestPermutation(permutation);
		recommendations.setSearchVectors(getSearchVectors(permutation));
		recommendations.setEnrichedSearchCriteria(getEnrichedContent(query));
		recommendations.setSurfaceForms(getSurfaceForms(query));
		return recommendations;
	}
	
	// Calls SSE and gets mapped concept for this query
	private Mappings getMappedConcepts(String query) {
	...
	private String getMappedConceptsAsString(String query) {
	...
	private Map<String, Map<String,Float>> getSearchVectors(String query) {
	...
	private String getEnrichedContent(String originalContent) {
	...
	private Set<String> getSurfaceForms(String originalContent) {
	...
	private String getBestPermutation(String originalContent) {
		
		String recommendation = originalContent;
		int numOfConcepts = getMappedConceptsAsString(originalContent).split(" ").length;
		...
		while (iterator.hasNext()) {
			...
			String concepts = getMappedConceptsAsString(query).trim();
